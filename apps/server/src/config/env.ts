...
const envSchema = z.object({
  ...
  DEPT_ADMIN_EMAIL: z.string().optional(),
  DEPT_ADMIN_PASSWORD: z.string().optional(),
  DEPT_ADMIN_FIRST_NAME: z.string().default('Department'),
  DEPT_ADMIN_LAST_NAME: z.string().default('Admin'),
  ...
  INACTIVITY_TIMEOUT_MINUTES: z.coerce.number().default(60),
